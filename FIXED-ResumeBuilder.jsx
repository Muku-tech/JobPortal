...
import { ModernTemplate, ClassicTemplate, CreativeTemplate, ExecutiveTemplate } from './ResumeTemplates';
...
const ResumeBuilder = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    const opt = {
      margin: [10, 15, 10, 15],
      filename: `${resumeData.personal_info.name.replace(/\s+/g, '_')}_${previewTemplate}_Resume.pdf`,
  ...
  return (
    <div className="resume-builder-page">
      ...
      {editing ? (
        ...
        <div ref={resumeRef} className="resume-preview" style={{
          ...
          {previewTemplate === 'modern' && <ModernTemplate resumeData={resumeData} sectionKeys={sectionKeys} />}
          {previewTemplate === 'classic' && <ClassicTemplate resumeData={resumeData} sectionKeys={sectionKeys} />}
          {previewTemplate === 'creative' && <CreativeTemplate resumeData={resumeData} sectionKeys={sectionKeys} />}
          {previewTemplate === 'executive' && <ExecutiveTemplate resumeData={resumeData} sectionKeys={sectionKeys} />}
        </div>
      )}
    </div>
  );
